 ...
 */
var walkChallenge : [String] = ["1000 steps","100000 steps"];
var runningChallenge : [String] = ["5 KM","10KM"];
...
var challenges = [walkChallenge,runningChallenge];
...
if(!newChallenge.isEmpty){
    if(newChallenge.count == 1){
        print("The Challenge you have chosen is \(newChallenge)");
    }
    else{

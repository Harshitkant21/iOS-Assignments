...
print("yes, the main difference is in the declaration in this we have the schooling using var at last we had declared goalSteps using let which make value constant ")
